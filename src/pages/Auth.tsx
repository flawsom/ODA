      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        <Card className="min-w-[350px] pb-0 border shadow-md">
          {step === "signIn" ? (
            <>
              <CardHeader className="text-center">
                <div
                  className="mb-4 mt-4 flex cursor-pointer items-center justify-center gap-3"
                  onClick={() => navigate("/")}
                >
                  <svg viewBox="0 0 40 40" fill="none" className="size-10" aria-hidden>
                  ...
                  <div className="text-left leading-tight">
                    <p className="font-display text-lg font-semibold tracking-wide">ODA</p>
                    <p className="oda-label !text-[9px]">Omniscient Document Architect</p>
                  </div>
                </div>
                <CardTitle className="text-xl">Enter the Command Center</CardTitle>
                <CardDescription>
                  Sign in to ingest documents and forge responses
                </CardDescription>
              </CardHeader>
          ...
          <div className="py-4 px-6 text-xs text-center text-muted-foreground bg-muted border-t rounded-b-lg">
            Free forever · Open source · Every document, understood &amp; answered
          </div>
        </Card>
        </div>
      </div>
