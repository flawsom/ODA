// Domain Translation-Memory Engine (fidelity PRD §4.3) — seed pack. // anchor
//
...
/** 3-letter month abbreviations inside ref codes / dates ("07/JUL/2025"). */
export const MONTH_ABBR: Record<string, string> = {
  jan: "जन", feb: "फ़र", mar: "मार्च", apr: "अप्रै", may: "मई",
  jun: "जून", jul: "जुल", aug: "अग", sep: "सित", oct: "अक्टू",
  nov: "नव", dec: "दिस",
};
...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  {
    // The L.C.-OUT "Ledger Card not available" reply (letters 61/29) — the
    // OCR'ed word order ("enclosed please find", not "please find
    // enclosed") differs from the extract template above, and the card is
    // "in respect of Sri …" with the account on the same line.
    en: "On the subject and reference cited above, enclosed please find herewith the Ledger Card in respect of Sri {1} CMPF A/C No- {2} as required.",
    tr: {
      Hindi: "उपरोक्त विषय एवं संदर्भ के आलोक में, श्री {1}, सीएमपीएफ खाता संख्या- {2} का लेजर कार्ड संलग्न रूप में प्रेषित है।",
      Tamil: "மேற்கூறிய விஷயம் மற்றும் குறிப்பின் பார்வையில், திரு {1}, CMPF கணக்கு எண்- {2} தொடர்பான லெட்ஜர் அட்டை இணைப்புடன் அனுப்பப்படுகிறது.",
      Bengali: "উপরোক্ত বিষয় ও সূত্রের প্রেক্ষিতে, শ্রী {1}, সিএমপিএফ হিসাব নং- {2} এর লেজার কার্ড সংযুক্তভাবে প্রেরণ করা হলো।",
      Telugu: "పై విషయం మరియు సూచన దృష్ట్యా, శ్రీ {1}, CMPF ఖాతా నం- {2} యొక్క లెడ్జర్ కార్డు జోడింపుతో పంపబడుతోంది.",
      Kannada: "ಮೇಲಿನ ವಿಷಯ ಮತ್ತು ಉಲ್ಲೇಖದ ದೃಷ್ಟಿಯಿಂದ, ಶ್ರೀ {1}, CMPF ಖಾತೆ ಸಂಖ್ಯೆ- {2} ರ ಲೆಡ್ಜರ್ ಕಾರ್ಡ್ ಅನ್ನು ಲಗತ್ತಾಗಿ ಕಳುಹಿಸಲಾಗುತ್ತಿದೆ.",
      Gujarati: "ઉપરોક્ત વિષય અને સંદર્ભના આલોકમાં, શ્રી {1}, CMPF ખાતું નં- {2} નું લેજર કાર્ડ જોડાણ સાથે મોકલવામાં આવે છે.",
      Marathi: "वरील विषय आणि संदर्भाच्या अनुषंगाने, श्री {1}, CMPF खाते क्र- {2} चे लेजर कार्ड संलग्नपणे पाठविले जात आहे.",
      Spanish: "En virtud del asunto y la referencia antes citados, se remite adjunta la tarjeta de contabilidad de Shri {1}, cuenta CMPF N.º {2}.",
      French: "Au vu de l'objet et de la référence susmentionnés, la carte de comptes de Shri {1}, compte CMPF n° {2}, est transmise ci-jointe.",
      Arabic: "على ضوء الموضوع والمرجع المذكورين أعلاه، تُرفق بطاقة الحساب الخاصة بالسيد {1}، حساب CMPF رقم {2}.",
    },
  },
  {
    // The same reply for the EXTRACT variant ("the extract i n r/o- Sri …").
    en: "On the subject and reference cited above, enclosed please find herewith the extract in respect of Sri {1} CMPF A/C No- {2} as required.",
    tr: {
      Hindi: "उपरोक्त विषय एवं संदर्भ के आलोक में, श्री {1}, सीएमपीएफ खाता संख्या- {2} के संबंध में संलग्न उद्धरण (एक्सट्रैक्ट) आपके अवलोकनार्थ प्रेषित है।",
      Tamil: "மேற்கூறிய விஷயம் மற்றும் குறிப்பின் பார்வையில், திரு {1}, CMPF கணக்கு எண்- {2} தொடர்பாக இணைக்கப்பட்ட சாற்றெடுப்பு (எக்ஸ்ட்ராக்ட்) உங்கள் பார்வைக்காக அனுப்பப்படுகிறது.",
      Bengali: "উপরোক্ত বিষয় ও সূত্রের প্রেক্ষিতে, শ্রী {1}, সিএমপিএফ হিসাব নং- {2} সম্পর্কে সংযুক্ত উদ্ধৃতি (এক্সট্রাক্ট) আপনার অবলোকনের জন্য প্রেরণ করা হলো।",
  ...
  {
    // The Ranchi-II "Ledger Card is not available" reply (letter 89) — the
    // OCR-typo'd line (Refarence, stat, scattered abbreviation spaces) is
    // repaired by Pass 0 into this canonical form.
    en: "With reference to your office letter no {1} dated {2} on the above cited subject,it is to state that the Ledger Card in respect of Shri {3}, C.M.P.F. A/c No- {4} is not available in this region.",
    tr: {
      Hindi: "आपके कार्यालय पत्र संख्या- {1} दिनांक {2} के संदर्भ में, उपरोक्त विषय के आलोक में कहा जाता है कि श्री {3}, सी.एम.पी.एफ. खाता संख्या- {4} का लेजर कार्ड इस क्षेत्र में उपलब्ध नहीं है।",
      Tamil: "உங்கள் அலுவலக கடித எண் {1} தேதி {2} குறித்து, மேற்கூறிய விஷயத்தின் பார்வையில், திரு {3}, C.M.P.F. கணக்கு எண்- {4} தொடர்பான லெட்ஜர் அட்டை இந்த பிராந்தியத்தில் கிடைக்கவில்லை எனத் தெரிவிக்கப்படுகிறது.",
      Bengali: "আপনার কার্যালয় পত্র নং {1} তারিখ {2} এর সূত্রে, উপরোক্ত বিষয়ের প্রেক্ষিতে জানানো হচ্ছে যে, শ্রী {3}, সি.এম.পি.এফ. হিসাব নং- {4} এর লেজার কার্ড এই অঞ্চলে পাওয়া যায় না।",
      Telugu: "మీ కార్యాలయ పత్రం నం {1} తేదీ {2} సూచనతో, పై విషయం దృష్ట్యా, శ్రీ {3}, సి.ఎం.పి.ఎఫ్. ఖాతా నం- {4} యొక్క లెడ్జర్ కార్డు ఈ ప్రాంతంలో అందుబాటులో లేదని తెలియజేయబడుతోంది.",
      Kannada: "ನಿಮ್ಮ ಕಚೇರಿ ಪತ್ರ ಸಂಖ್ಯೆ {1} ದಿನಾಂಕ {2} ಉಲ್ಲೇಖದೊಂದಿಗೆ, ಮೇಲಿನ ವಿಷಯದ ದೃಷ್ಟಿಯಿಂದ, ಶ್ರೀ {3}, C.M.P.F. ಖಾತೆ ಸಂಖ್ಯೆ- {4} ರ ಲೆಡ್ಜರ್ ಕಾರ್ಡ್ ಈ ಪ್ರದೇಶದಲ್ಲಿ ಲಭ್ಯವಿಲ್ಲ ಎಂದು ತಿಳಿಸಲಾಗುತ್ತದೆ.",
      Gujarati: "તમારા કાર્યાલય પત્ર નં {1} તારીખ {2} ના સંદર્ભમાં, ઉપરોક્ત વિષયના આલોકમાં જણાવવામાં આવે છે કે શ્રી {3}, C.M.P.F. ખાતું નં- {4} નું લેજર કાર્ડ આ પ્રદેશમાં ઉપલબ્ધ નથી.",
      Marathi: "तुमच्या कार्यालयीन पत्र क्र. {1} दिनांक {2} च्या संदर्भात, वरील विषयाच्या अनुषंगाने कळविले जाते की, श्री {3}, C.M.P.F. खाते क्र- {4} चे लेजर कार्ड या प्रदेशात उपलब्ध नाही.",
      Spanish: "Con referencia a su carta de oficina N.º {1} de fecha {2}, en virtud del asunto antes citado, se informa que la tarjeta de contabilidad de Shri {3}, cuenta C.M.P.F. N.º {4}, no está disponible en esta Región.",
      French: "Au vu de votre lettre de bureau n° {1} du {2}, et au titre de l'objet susmentionné, il est porté à votre connaissance que la carte de comptes de Shri {3}, compte C.M.P.F. n° {4}, n'est pas disponible dans cette Région.",
      Arabic: "بالإشارة إلى كتاب مكتبكم رقم {1} بتاريخ {2}، وعلى ضوء الموضوع المذكور أعلاه، يُفيد بأن بطاقة الحساب الخاصة بالسيد {3}، حساب C.M.P.F. رقم {4}، غير متوفرة في هذه المنطقة.",
    },
  },
  {
    // The Sambalpur "inadvertently sent" reply (letter 68) — the longest of
    // the not-available family.
    en: "Kindly refer to this office letter no {1} dated {2} (copy enclosed) on the subject cited above it is to inform that the Original Ledger Card of Shri {3}, {4} was inadvertently sent to your office instead of CMPFO, R.O., Sambalpur.",
    tr: {
      Hindi: "कृपया इस कार्यालय पत्र संख्या- {1} दिनांक {2} (प्रति संलग्न) पर उपरोक्त विषय के संदर्भ में सूचित किया जाता है कि श्री {3}, {4} का मूल लेजर कार्ड अनजाने में सीएमपीएफओ, क्षेत्रीय कार्यालय, संबलपुर के स्थान पर आपके कार्यालय को भेज दिया गया था।",
      Tamil: "தயவுசெய்து இந்த அலுவலக கடித எண் {1} தேதி {2} (நகல் இணைக்கப்பட்டுள்ளது) மேற்கூறிய விஷயத்தைக் குறித்து, திரு {3}, {4} இன் மூல லெட்ஜர் அட்டை தற்செயலாக CMPFO, R.O., சம்பல்பூர் பதிலாக உங்கள் அலுவலகத்திற்கு அனுப்பப்பட்டது எனத் தெரிவிக்கப்படுகிறது.",
      Bengali: "অনুগ্রহ করে এই কার্যালয় পত্র নং {1} তারিখ {2} (প্রতি সংযুক্ত) উপরোক্ত বিষয়ের সূত্রে জানানো হচ্ছে যে, শ্রী {3}, {4} এর মূল লেজার কার্ড অনিচ্ছাকৃতভাবে CMPFO, R.O., সম্বলপুরের পরিবর্তে আপনার কার্যালয়ে পাঠানো হয়েছিল।",
      Telugu: "దయచేసి ఈ కార్యాలయ పత్రం నం {1} తేదీ {2} (కాపీ జోడించబడింది) పై విషయం సూచనతో, శ్రీ {3}, {4} యొక్క అసలు లెడ్జర్ కార్డు అనుకోకుండా CMPFO, R.O., సంబల్పూర్ బదులు మీ కార్యాలయానికి పంపబడిందని తెలియజేయబడుతోంది.",
      Kannada: "ದಯವಿಟ್ಟು ಈ ಕಚೇರಿ ಪತ್ರ ಸಂಖ್ಯೆ {1} ದಿನಾಂಕ {2} (ಪ್ರತಿ ಲಗತ್ತಿಸಲಾಗಿದೆ) ಮೇಲಿನ ವಿಷಯದ ಉಲ್ಲೇಖದೊಂದಿಗೆ, ಶ್ರೀ {3}, {4} ರ ಮೂಲ ಲೆಡ್ಜರ್ ಕಾರ್ಡ್ ಅನ್ನು ಅಜಾಗರೂಕತೆಯಿಂದ CMPFO, R.O., ಸಂಬಲ್ಪುರ್ ಬದಲಿಗೆ ನಿಮ್ಮ ಕಚೇರಿಗೆ ಕಳುಹಿಸಲಾಗಿದೆ ಎಂದು ತಿಳಿಸಲಾಗುತ್ತದೆ.",
      Gujarati: "કૃપા કરીને આ કાર્યાલય પત્ર નં {1} તારીખ {2} (પ્રતિ સંલગ્ન) ઉપરોક્ત વિષયના સંદર્ભમાં જણાવવામાં આવે છે કે શ્રી {3}, {4} નું મૂળ લેજર કાર્ડ અજાણતાં CMPFO, R.O., સંબલપુરને બદલે તમારા કાર્યાલયને મોકલવામાં આવ્યું હતું.",
      Marathi: "कृपया या कार्यालयीन पत्र क्र. {1} दिनांक {2} (प्रत संलग्न) वरील विषयाच्या संदर्भात कळविले जाते की, श्री {3}, {4} चे मूळ लेजर कार्ड अनावधानाने CMPFO, R.O., संबलपूर यांच्या ऐवजी तुमच्या कार्यालयास पाठविले गेले होते.",
      Spanish: "Sírvase remitirse a la carta de esta oficina N.º {1} de fecha {2} (copia adjunta) y, en relación con el asunto antes citado, se informa de que la tarjeta de contabilidad original de Shri {3}, {4}, fue enviada inadvertidamente a su oficina en lugar de a la CMPFO, R.O., Sambalpur.",
      French: "Veuillez vous référer à la lettre de ce bureau n° {1} du {2} (copie jointe) et, au titre de l'objet susmentionné, il est porté à votre connaissance que la carte de comptes originale de Shri {3}, {4}, a été envoyée par inadvertance à votre bureau au lieu de la CMPFO, R.O., Sambalpur.",
      Arabic: "يُرجى الرجوع إلى كتاب هذا المكتب رقم {1} بتاريخ {2} (نسخة مرفقة)، وبخصوص الموضوع المذكور أعلاه، يُفيد بأن بطاقة الحساب الأصلية للسيد {3}، {4}، أُرسلت بالخطأ إلى مكتبكم بدلاً من CMPFO، R.O.، سامبالبور.",
    },
  },
  {
    // The Singrauli "non-receipt of enclosures" reply (letter 71) — subject
    // and the three body sentences, each matched on its own.
    en: "Non-receipt of enclosures regarding Ledger Card requisition of various members.",
    tr: {
      Hindi: "लेजर कार्ड प्राप्ति-संबंधी विभिन्न सदस्यों की संलग्नियों की अप्राप्ति।",
      Tamil: "பல்வேறு உறுப்பினர்களின் லெட்ஜர் அட்டை கோரிக்கை தொடர்பான இணைப்புகள் பெறப்படாதது.",
      Bengali: "বিভিন্ন সদস্যের লেজার কার্ড প্রাপ্তি সংক্রান্ত সংযুক্তিগুলি না পাওয়া।",
      Telugu: "వివిధ సభ్యుల లెడ్జర్ కార్డు అభ్యర్థనకు సంబంధించిన జోడింపులు అందకపోవడం.",
      Kannada: "ವಿವಿಧ ಸದಸ್ಯರ ಲೆಡ್ಜರ್ ಕಾರ್ಡ್ ಬೇಡಿಕೆಗೆ ಸಂಬಂಧಿಸಿದ ಲಗತ್ತುಗಳು ಸಿಗದಿರುವುದು.",
      Gujarati: "વિવિધ સભ્યોની લેજર કાર્ડ માંગણી સંબંધિત જોડાણો ન મળવા.",
      Marathi: "विविध सदस्यांच्या लेजर कार्ड मागणीशी संबंधित संलग्नता न मिळणे.",
      Spanish: "No recepción de los anexos relativos a la solicitud de tarjetas de contabilidad de varios miembros.",
      French: "Non-réception des pièces jointes relatives à la demande de cartes de comptes de plusieurs membres.",
      Arabic: "عدم استلام المرفقات المتعلقة بطلب بطاقات الحساب لعدة أعضاء.",
    },
  },
  {
    en: "This is with reference to your letter cited above on the subject matter.",
    tr: {
      Hindi: "यह आपके उपरोक्त उद्धृत पत्र के विषय वस्तु के संदर्भ में है।",
      Tamil: "இது மேற்கூறிய விஷயம் தொடர்பாக மேலே குறிப்பிடப்பட்ட உங்கள் கடிதத்தைக் குறிக்கிறது.",
      Bengali: "এটি উপরোক্ত বিষয়ে আপনার উপরে উদ্ধৃত পত্রের সূত্রে।",
      Telugu: "ఇది పైన పేర్కొన్న విషయంపై మీ పైన ఉదహరించిన పత్రం సూచనతో ఉంది.",
      Kannada: "ಇದು ಮೇಲೆ ಉಲ್ಲೇಖಿಸಲಾದ ವಿಷಯದ ಕುರಿತು ನಿಮ್ಮ ಮೇಲೆ ಉದ್ಧರಿಸಿದ ಪತ್ರದ ಉಲ್ಲೇಖದಲ್ಲಿದೆ.",
      Gujarati: "આ ઉપરોક્ત વિષય બાબતે તમારા ઉપર ઉદ્ધૃત પત્રના સંદર્ભમાં છે.",
      Marathi: "हे वरील विषयाबाबत तुमच्या वर उद्धृत पत्राच्या संदर्भात आहे.",
      Spanish: "La presente hace referencia a su carta antes citada sobre el asunto en cuestión.",
      French: "La présente se réfère à votre lettre susmentionnée au sujet de l'objet.",
      Arabic: "هذا بالإشارة إلى كتابكم المذكور أعلاه بشأن الموضوع.",
    },
  },
  {
    en: "It is to bring to your notice that the enclosures containing the period of work for the members listed below, which were indicated as attached in your letter, were not received at this office.",
    tr: {
      Hindi: "यह आपके संज्ञान में लाया जाता है कि नीचे सूचीबद्ध सदस्यों के कार्य अवधि वाली संलग्नियाँ, जो आपके पत्र में संलग्न बताई गई थीं, इस कार्यालय में प्राप्त नहीं हुईं।",
      Tamil: "கீழே பட்டியலிடப்பட்டுள்ள உறுப்பினர்களின் பணி காலம் அடங்கிய இணைப்புகள், உங்கள் கடிதத்தில் இணைக்கப்பட்டதாகக் குறிப்பிடப்பட்டிருந்தாலும், இந்த அலுவலகத்தில் பெறப்படவில்லை என்பதை உங்கள் கவனத்திற்குக் கொண்டு வரப்படுகிறது.",
      Bengali: "আপনার জানানো হচ্ছে যে, নীচে তালিকাভুক্ত সদস্যদের কাজের সময়কাল সম্বলিত সংযুক্তিগুলি, যা আপনার পত্রে সংযুক্ত বলে নির্দেশ করা হয়েছিল, এই কার্যালয়ে প্রাপ্ত হয়নি।",
      Telugu: "మీ పత్రంలో జోడించబడ్డాయని సూచించబడిన, క్రింద జాబితా చేయబడిన సభ్యుల పని కాలం కలిగిన జోడింపులు ఈ కార్యాలయంలో అందలేదని మీ దృష్టికి తీసుకురాబడుతోంది.",
      Kannada: "ನಿಮ್ಮ ಪತ್ರದಲ್ಲಿ ಲಗತ್ತಿಸಲಾಗಿದೆ ಎಂದು ಸೂಚಿಸಲಾದ, ಕೆಳಗೆ ಪಟ್ಟಿಮಾಡಲಾದ ಸದಸ್ಯರ ಕೆಲಸದ ಅವಧಿಯನ್ನು ಒಳಗೊಂಡ ಲಗತ್ತುಗಳು ಈ ಕಚೇರಿಯಲ್ಲಿ ಸ್ವೀಕರಿಸಲಾಗಿಲ್ಲ ಎಂದು ನಿಮ್ಮ ಗಮನಕ್ಕೆ ತರಲಾಗುತ್ತದೆ.",
      Gujarati: "તમારા ધ્યાન પર લાવવામાં આવે છે કે, તમારા પત્રમાં સંલગ્ન હોવાનું સૂચવવામાં આવેલ નીચે સૂચિબદ્ધ સભ્યોની કામગીરી અવધિ ધરાવતી જોડાણો આ કાર્યાલયમાં પ્રાપ્ત થઈ નથી.",
      Marathi: "तुमच्या पत्रात संलग्न असल्याचे सूचित केलेले, खाली सूचीबद्ध सदस्यांच्या कार्य कालावधीचा समावेश असलेल्या संलग्नता या कार्यालयात प्राप्त झाल्या नाहीत, असे आपल्या निदर्शनास आणले जाते.",
      Spanish: "Se pone en su conocimiento que los anexos que contienen el período de trabajo de los miembros enumerados a continuación, que fueron indicados como adjuntos en su carta, no fueron recibidos en esta oficina.",
      French: "Il est porté à votre connaissance que les pièces jointes contenant la période de travail des membres énumérés ci-dessous, qui étaient indiquées comme jointes dans votre lettre, n'ont pas été reçues à ce bureau.",
      Arabic: "يُحيط علمكم بأن المرفقات التي تتضمن فترة عمل الأعضاء المدرجين أدناه، والتي أُشير إليها كمرفقة في كتابكم، لم يتم استلامها في هذا المكتب.",
    },
  },
  {
    en: "The absence of these requisite details precludes further processing from our end.",
    tr: {
      Hindi: "इन आवश्यक विवरणों के अभाव में हमारी ओर से आगे की कार्रवाई संभव नहीं है।",
      Tamil: "இந்த தேவையான விவரங்கள் இல்லாததால், எங்கள் முனையில் மேலும் செயலாக்கம் சாத்தியமில்லை.",
      Bengali: "এই প্রয়োজনীয় বিবরণগুলির অভাবে আমাদের পক্ষ থেকে আরও প্রক্রিয়াকরণ সম্ভব নয়।",
      Telugu: "ఈ అవసరమైన వివరాలు లేకపోవడంతో, మా వైపు నుండి మరింత ప్రాసెసింగ్ సాధ్యం కాదు.",
      Kannada: "ಈ ಅಗತ್ಯ ವಿವರಗಳ ಅನುಪಸ್ಥಿತಿಯಲ್ಲಿ, ನಮ್ಮ ಕಡೆಯಿಂದ ಮತ್ತಷ್ಟು ಪ್ರಕ್ರಿಯೆ ಸಾಧ್ಯವಿಲ್ಲ.",
      Gujarati: "આ આવશ્યક વિગતોના અભાવમાં, અમારી તરફથી આગળની કાર્યવાહી શક્ય નથી.",
      Marathi: "या आवश्यक तपशिलांच्या अभावी, आमच्या बाजूने पुढील प्रक्रिया शक्य नाही.",
      Spanish: "La ausencia de estos detalles requeridos impide continuar el trámite por nuestra parte.",
      French: "L'absence de ces détails requis empêche toute suite à donner de notre côté.",
      Arabic: "إن غياب هذه التفاصيل المطلوبة يمنع مواصلة الإجراءات من جانبنا.",
    },
  },
  {
    en: "It is therefore requested that the necessary documents for all three members be furnished at the earliest to enable us to proceed further in the matter.",
    tr: {
      Hindi: "अतः अनुरोध है कि तीनों सदस्यों के लिए आवश्यक दस्तावेज़ शीघ्रातिशीघ्र उपलब्ध कराए जाएँ ताकि इस मामले में आगे की कार्रवाई की जा सके।",
      Tamil: "எனவே, மூன்று உறுப்பினர்களுக்கும் தேவையான ஆவணங்களை விரைவில் வழங்குமாறு கேட்டுக்கொள்ளப்படுகிறது, இதனால் இந்த விஷயத்தில் நாங்கள் தொடர்ந்து செயல்பட முடியும்.",
      Bengali: "অতএব, তিনজন সদস্যের জন্য প্রয়োজনীয় দলিল যত দ্রুত সম্ভব প্রদান করার অনুরোধ করা হচ্ছে, যাতে আমরা এই বিষয়ে আরও এগিয়ে যেতে পারি।",
      Telugu: "అందువల్ల, ఈ విషయంలో మేము ముందుకు సాగడానికి వీలుగా ముగ్గురు సభ్యులకు అవసరమైన పత్రాలను వీలైనంత త్వరగా అందించాలని అభ్యర్థించబడుతోంది.",
      Kannada: "ಆದ್ದರಿಂದ, ಈ ವಿಷಯದಲ್ಲಿ ನಾವು ಮುಂದುವರಿಯಲು ಅನುವಾಗುವಂತೆ ಮೂವರು ಸದಸ್ಯರಿಗೆ ಅಗತ್ಯ ದಾಖಲೆಗಳನ್ನು ಸಾಧ್ಯವಾದಷ್ಟು ಬೇಗ ಒದಗಿಸುವಂತೆ ಕೋರಲಾಗುತ್ತದೆ.",
      Gujarati: "તેથી, આ બાબતમાં અમે આગળ વધી શકીએ તે માટે ત્રણેય સભ્યો માટે જરૂરી દસ્તાવેજો શક્ય તેટલી વહેલી ઉપલબ્ધ કરાવવાની વિનંતી કરવામાં આવે છે.",
      Marathi: "म्हणून, या बाबतीत आम्ही पुढे जाऊ शकू यासाठी तिन्ही सदस्यांसाठी आवश्यक कागदपत्रे शक्य तितक्या लवकर पुरविण्याची विनंती करण्यात येते.",
      Spanish: "Por lo tanto, se solicita que los documentos necesarios de los tres miembros se faciliten a la mayor brevedad para que podamos continuar con el asunto.",
      French: "Il est donc demandé que les documents nécessaires des trois membres soient fournis dans les plus brefs délais afin que nous puissions poursuivre le traitement de cette affaire.",
      Arabic: "لذلك يُرجى تقديم المستندات اللازمة للأعضاء الثلاثة في أقرب وقت ممكن لتمكيننا من مواصلة الإجراءات في هذا الشأن.",
    },
  },
  {
    en: "Your prompt attention to this matter would be highly appreciated.",
    tr: {
      Hindi: "इस मामले पर आपका त्वरित ध्यान अत्यधिक सराहनीय होगा।",
      Tamil: "இந்த விஷயத்தில் உங்கள் உடனடி கவனம் மிகவும் பாராட்டப்படும்.",
      Bengali: "এই বিষয়ে আপনার দ্রুত মনোযোগ অত্যন্ত প্রশংসিত হবে।",
      Telugu: "ఈ విషయంలో మీ తక్షణ శ్రద్ధ ఎంతో అభినందనీయంగా ఉంటుంది.",
      Kannada: "ಈ ವಿಷಯದಲ್ಲಿ ನಿಮ್ಮ ತ್ವರಿತ ಗಮನವನ್ನು ಹೆಚ್ಚು ಪ್ರಶಂಸಿಸಲಾಗುತ್ತದೆ.",
      Gujarati: "આ બાબત પર તમારું ત્વરિત ધ્યાન અત્યંત પ્રશંસનીય રહેશે.",
      Marathi: "या बाबतीत तुमचे त्वरित लक्ष अत्यंत कौतुकास्पद ठरेल.",
      Spanish: "Agradeceríamos mucho su pronta atención a este asunto.",
      French: "Votre attention rapide à cette affaire serait grandement appréciée.",
      Arabic: "سيكون موضع تقدير كبير اهتمامكم العاجل بهذا الشأن.",
    },
  },
  {
    // Letter 71's closing paragraph is OCR-fused into ONE line WITHOUT the
    // sentence periods ("…from our en d It is therefore…"), so the three
    // sentences above cannot be split — this fused twin matches the whole
    // line (the flex pattern tolerates the stray "en d" space).
    en: "The absence of these requisite details precludes further processing from our end It is therefore requested that the necessary documents for all three members be furnished at the earliest to enable us to proceed further in the matter Your prompt attention to this matter would be highly appreciated.",
    tr: {
      Hindi: "इन आवश्यक विवरणों के अभाव में हमारी ओर से आगे की कार्रवाई संभव नहीं है। अतः अनुरोध है कि तीनों सदस्यों के लिए आवश्यक दस्तावेज़ शीघ्रातिशीघ्र उपलब्ध कराए जाएँ ताकि इस मामले में आगे की कार्रवाई की जा सके। इस मामले पर आपका त्वरित ध्यान अत्यधिक सराहनीय होगा।",
      Tamil: "இந்த தேவையான விவரங்கள் இல்லாததால், எங்கள் முனையில் மேலும் செயலாக்கம் சாத்தியமில்லை. எனவே, மூன்று உறுப்பினர்களுக்கும் தேவையான ஆவணங்களை விரைவில் வழங்குமாறு கேட்டுக்கொள்ளப்படுகிறது, இதனால் இந்த விஷயத்தில் நாங்கள் தொடர்ந்து செயல்பட முடியும். இந்த விஷயத்தில் உங்கள் உடனடி கவனம் மிகவும் பாராட்டப்படும்.",
      Bengali: "এই প্রয়োজনীয় বিবরণগুলির অভাবে আমাদের পক্ষ থেকে আরও প্রক্রিয়াকরণ সম্ভব নয়। অতএব, তিনজন সদস্যের জন্য প্রয়োজনীয় দলিল যত দ্রুত সম্ভব প্রদান করার অনুরোধ করা হচ্ছে, যাতে আমরা এই বিষয়ে আরও এগিয়ে যেতে পারি। এই বিষয়ে আপনার দ্রুত মনোযোগ অত্যন্ত প্রশংসিত হবে।",
      Telugu: "ఈ అవసరమైన వివరాలు లేకపోవడంతో, మా వైపు నుండి మరింత ప్రాసెసింగ్ సాధ్యం కాదు. అందువల్ల, ఈ విషయంలో మేము ముందుకు సాగడానికి వీలుగా ముగ్గురు సభ్యులకు అవసరమైన పత్రాలను వీలైనంత త్వరగా అందించాలని అభ్యర్థించబడుతోంది. ఈ విషయంలో మీ తక్షణ శ్రద్ధ ఎంతో అభినందనీయంగా ఉంటుంది.",
      Kannada: "ಈ ಅಗತ್ಯ ವಿವರಗಳ ಅನುಪಸ್ಥಿತಿಯಲ್ಲಿ, ನಮ್ಮ ಕಡೆಯಿಂದ ಮತ್ತಷ್ಟು ಪ್ರಕ್ರಿಯೆ ಸಾಧ್ಯವಿಲ್ಲ. ಆದ್ದರಿಂದ, ಈ ವಿಷಯದಲ್ಲಿ ನಾವು ಮುಂದುವರಿಯಲು ಅನುವಾಗುವಂತೆ ಮೂವರು ಸದಸ್ಯರಿಗೆ ಅಗತ್ಯ ದಾಖಲೆಗಳನ್ನು ಸಾಧ್ಯವಾದಷ್ಟು ಬೇಗ ಒದಗಿಸುವಂತೆ ಕೋರಲಾಗುತ್ತದೆ. ಈ ವಿಷಯದಲ್ಲಿ ನಿಮ್ಮ ತ್ವರಿತ ಗಮನವನ್ನು ಹೆಚ್ಚು ಪ್ರಶಂಸಿಸಲಾಗುತ್ತದೆ.",
      Gujarati: "આ આવશ્યક વિગતોના અભાવમાં, અમારી તરફથી આગળની કાર્યવાહી શક્ય નથી. તેથી, આ બાબતમાં અમે આગળ વધી શકીએ તે માટે ત્રણેય સભ્યો માટે જરૂરી દસ્તાવેજો શક્ય તેટલી વહેલી ઉપલબ્ધ કરાવવાની વિનંતી કરવામાં આવે છે. આ બાબત પર તમારું ત્વરિત ધ્યાન અત્યંત પ્રશંસનીય રહેશે.",
      Marathi: "या आवश्यक तपशिलांच्या अभावी, आमच्या बाजूने पुढील प्रक्रिया शक्य नाही. म्हणून, या बाबतीत आम्ही पुढे जाऊ शकू यासाठी तिन्ही सदस्यांसाठी आवश्यक कागदपत्रे शक्य तितक्या लवकर पुरविण्याची विनंती करण्यात येते. या बाबतीत तुमचे त्वरित लक्ष अत्यंत कौतुकास्पद ठरेल.",
      Spanish: "La ausencia de estos detalles requeridos impide continuar el trámite por nuestra parte. Por lo tanto, se solicita que los documentos necesarios de los tres miembros se faciliten a la mayor brevedad para que podamos continuar con el asunto. Agradeceríamos mucho su pronta atención a este asunto.",
      French: "L'absence de ces détails requis empêche toute suite à donner de notre côté. Il est donc demandé que les documents nécessaires des trois membres soient fournis dans les plus brefs délais afin que nous puissions poursuivre le traitement de cette affaire. Votre attention rapide à cette affaire serait grandement appréciée.",
      Arabic: "إن غياب هذه التفاصيل المطلوبة يمنع مواصلة الإجراءات من جانبنا. لذلك يُرجى تقديم المستندات اللازمة للأعضاء الثلاثة في أقرب وقت ممكن لتمكيننا من مواصلة الإجراءات في هذا الشأن. سيكون موضع تقدير كبير اهتمامكم العاجل بهذا الشأن.",
    },
  },
  {
